...
unless ApplicationHelper.included_modules.include?(RedmineZenedit::Patches::ApplicationHelperPatch)
  ApplicationHelper.send(:include, RedmineZenedit::Patches::ApplicationHelperPatch)
end
